...
<table width="100%" border="0" style="border-top:#FFFFFF solid 3px;" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="53" colspan="4" align="center"><h1>MEMBER REQUEST</h1></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td width="98%" align="center" bgcolor="#FFFFFF" style="color:#000000;font-size:14px;font-weight:bold"><table width="100%" border="1">
...
?>
      <tr>
        ...
        <td align="center">
              <a href="app.php?ten_id=<?php echo $res->ten_id; ?>" style="text-decoration:none">
              <input type="button" value="View Member" style="width:90px"/>
              </a>
        </td>
      </tr>
      <?php } ?>
