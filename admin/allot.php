...
<table width="100%" border="0" style="border-top:#FFFFFF solid 3px;" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="53" colspan="4" align="center"><h1>ISSUED BOOKS</h1></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td width="10%" align="center"><strong>Issued<br />
      Date</strong></td>
...
<?php echo "Issued to <strong>".$res->supp_name."</strong>"; ?>
</td>
  	</tr>
