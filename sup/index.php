...
<table width="100%" border="0" style="border-top:#FFFFFF solid 3px;" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="53" colspan="4" align="center"><h1>VIEW BOOKS</h1></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
...
<?php
$sel = "select * from tender where ten_status = 'Published' order by ten_id desc";
...
?>   
    ...
    <td align="center">
<?php
$sels = "select * from application where app_sup = '".$_SESSION['user_id']."' AND app_ten = '".$res->ten_id."'";
$froms = mysql_query($sels);
$ress=mysql_fetch_object($froms);
if($ress > 0)
{
echo "Requested";
}
...
{
?>    
    <a href="apply.php?ten_id=<?php echo $res->ten_id; ?>" style="text-decoration:none">
    <input type="button" value="Book" style="width:50px"/></a>
<?php } ?>
</td>
  	</tr>
