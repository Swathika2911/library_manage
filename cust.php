...
<table width="100%" border="0" style="border-top:#FFFFFF solid 3px;">
  ...
  <tr>
    <td height="53" colspan="4" align="center"><h1>Library Login</h1></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td width="62%" align="center" bgcolor="#FFFFFF" valign="top">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regno&nbsp;
<input type="text" name="reg_name" placeholder="enter your name" required >&nbsp;&nbsp;Email Id &nbsp;&nbsp;<input type="text" name="reg_email" placeholder="enter your email id" required ></h3>
<br />
...
$sqlup="Select * from customer
	where cust_uname='".$user_uname."' AND cust_pwd='".$user_pwd."'";
...
if($res > 0)
{
$_SESSION['user_id']=$res->cust_id;
$_SESSION['user_uname']=$cust_uname;
$_SESSION['user_name']=$res->cust_name;

	echo "<script type='text/javascript'> alert('Login Successfully');</script>";

	echo "<meta http-equiv='refresh' content='0;url=cust/index.php'>";
...
{
$ins="INSERT INTO `customer` (`cust_name` ,`cust_email` ,`cust_uname` ,`cust_pwd`)
