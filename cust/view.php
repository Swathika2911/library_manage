...
<table width="100%" border="0" style="border-top:#FFFFFF solid 3px;" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="53" colspan="4" align="center"><h1>BOOKS ISSUED</h1></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
...
<?php
$sel = "select * from tender where ten_user = '".$_SESSION['user_id']."' order by ten_id desc";
...
<br />
<?php if($res->ten_status == "Pending") {  ?>
    <a href="index.php?ten_id=<?php echo $res->ten_id; ?>&Mode=Edit" style="text-decoration:none;">
    <input type="button" value="Edit" style="width:50px"/></a><br />
<br />
   <a href="index.php?ten_id=<?php echo $res->ten_id; ?>&Mode=Delete" style="text-decoration:none" onclick="return confirm('Are You Sure To Delete?')">
    <input type="button" value="Delete" style="width:50px" /></a>  
    <?php } elseif($res->ten_status == "Published") {  ?>
    <a href="index.php?ten_id=<?php echo $res->ten_id; ?>&Mode=Edit" style="text-decoration:none;">
    <input type="button" value="Edit" style="width:50px"/></a>
    <?php } else { ?>
    <a href="result.php?ten_id=<?php echo $res->ten_id; ?>" style="text-decoration:none;">
    <input type="button" value="View Member"/></a>
	<?php }  ?>
    <br /><br />
</td>
  	</tr>
